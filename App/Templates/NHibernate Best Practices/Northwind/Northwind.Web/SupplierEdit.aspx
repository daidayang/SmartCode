<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierEdit.aspx.cs" Inherits="Northwind.Web.SupplierEdit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
        <title>Suppliers Edit</title>
        <meta name="vs_targetSchema" content="http://schemas.microsoft.com/intellisense/ie5">
        <link rel="stylesheet" href="Style.css" type="text/css">
</head>
<body>
<H2 align="center">Suppliers Edit</H2>
        <table align="center">
            <tr>
        ...
        <form id="form" method="post" runat="server">
             <input type="hidden" id="uiSupplierID" runat="server" />
            <table align="center">
                <tr>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="uiHomePage" Runat="server" /></td>
                </tr>
            </table>
            <table align="center">
                <tr>
                    <td>
                        ...
                        <a href="SupplierList.aspx">View Suppliers List</a>
                    </td>
                </tr>
                <tr>
                    <td>
