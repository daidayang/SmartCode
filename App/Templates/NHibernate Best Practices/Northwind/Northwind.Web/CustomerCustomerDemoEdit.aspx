<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerCustomerDemoEdit.aspx.cs" Inherits="Northwind.Web.CustomerCustomerDemoEdit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
        <title>CustomerCustomerDemo Edit</title>
        <meta name="vs_targetSchema" content="http://schemas.microsoft.com/intellisense/ie5">
        <link rel="stylesheet" href="Style.css" type="text/css">
</head>
<body>
<H2 align="center">CustomerCustomerDemo Edit</H2>
        <table align="center">
            <tr>
        ...
        <form id="form" method="post" runat="server">
            <table align="center">
                <tr>
                    ...
                    <td><asp:DropDownList ID="uiCustomerID" Runat="server" Width="200" /></td>
                </tr>
                <tr>
                    <td class="label">CustomerTypeID</td>
                    <td><asp:DropDownList ID="uiCustomerTypeID" Runat="server" Width="200" /></td>
                </tr>
            </table>
            <table align="center">
                <tr>
                    <td>
                        ...
                        <a href="CustomerCustomerDemoList.aspx">View CustomerCustomerDemo List</a>
                    </td>
                </tr>
                <tr>
                    <td>
