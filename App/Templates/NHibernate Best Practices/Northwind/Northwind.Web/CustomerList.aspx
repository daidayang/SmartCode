<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="Northwind.Web.CustomerList" %>
...
<body>
    <form id="CustomerForm" method="post" runat="server">
            ...
            <asp:DataGrid Runat="server" ID="gridData" AllowPaging="True" PageSize="25"
                ...
                <Columns>
                    <asp:TemplateColumn HeaderText="Edit">
                        <ItemTemplate>
                            <a href='CustomerEdit.aspx?CustomerID=<%# Server.UrlEncode( DataBinder.Eval(Container.DataItem, "ID" ).ToString() )%>'>
                                edit</a>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="View">
                        <ItemTemplate>
                            <a href='CustomerView.aspx?CustomerID=<%# Server.UrlEncode( DataBinder.Eval(Container.DataItem, "ID" ).ToString() )%>'>
                                view</a>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:boundcolumn datafield="ID" headertext="CustomerID" sortexpression="ID" visible="True" />
            ...
            <table align="center">
                <tr>
                    <td>
                        <a href='CustomerEdit.aspx'>Add</a>
                    </td>
                </tr>
            </table>
        </form>
