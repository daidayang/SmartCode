...
Public Class Sample2
    ...
    Public Overloads Overrides Function OutputFileName() As String
        ...
        Return Table.Code + "_Sample2.txt"
    End Function
    ...
    Public Overloads Overrides Sub ProduceCode()
        WriteLine("Today Date is {0}", DateTime.Now)
        WriteLine("Today Date is " + DateTime.Now.ToShortDateString)
    End Sub

    Public Function SomeStringMethod() As String
        Return "Today Date is " + DateTime.Now.ToShortDateString
    End Function
End Class
