...
SET ANSI_NULLS ON 
GO
-- Stored Procedure usp_Orders_DeleteByPrimaryKey
...
-- Parameters:
	...
	If (EXISTS (SELECT * FROM dbo.sysobjects
			WHERE (Name = 'usp_Orders_DeleteByPrimaryKey') AND (Type = 'P')))
		DROP PROCEDURE usp_Orders_DeleteByPrimaryKey
	GO
...
-- Purpose: Generates a stored procedure to delete a row by its primary key 
 ...
 CREATE PROCEDURE usp_Orders_DeleteByPrimaryKey
 (
     @OrderID int  
)
 AS
