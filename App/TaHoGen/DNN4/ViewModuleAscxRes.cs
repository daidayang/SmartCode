...
namespace DNN4
{
    public class ViewModuleAscxRes : BaseTemplate
    {
        public ViewModuleAscxRes()
        {
            base.IsProjectTemplate = false;
            base.CreateOutputFile = true;
            base.Description = "";
            base.Name = "ViewModuleAscxRes";
            base.OutputFolder = @"DNN4\ViewModuleAscxRes";
        }

        public override string OutputFileName()
        {
            return Table.Code + ".ascx.sct";
        }

        public override void ProduceCode()
        {

            StreamReader reader = new StreamReader(TemplateBase.TemplatesBaseDirectory + "/DNN4/ViewModule.ascx.sct");
