...
namespace DNN4
{
    public class SqlDataProvider : BaseTemplate
    {
        public SqlDataProvider()
        {
            ...
            base.Description = "";
            base.Name = "SqlDataProvider";
            base.OutputFolder = @"DNN4\SqlDataProvider";
        }
        ...
        public override void ProduceCode()
        {
            ...
            StreamReader reader = new StreamReader(TemplateBase.TemplatesBaseDirectory + "/DNN4/SqlDataProvider.vb.sct");
