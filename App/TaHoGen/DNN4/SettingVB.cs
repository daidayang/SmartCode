...
namespace DNN4
{
    public class SettingVB : BaseTemplate
    {
        public SettingVB()
        {
            ...
            base.Description = "";
            base.Name = "SettingVB";
            base.OutputFolder = @"DNN4\SettingVB";
        }
        ...
        public override void ProduceCode()
        {
            ...
            StreamReader reader = new StreamReader(TemplateBase.TemplatesBaseDirectory + "/DNN4/Settings.ascx.vb.sct");
