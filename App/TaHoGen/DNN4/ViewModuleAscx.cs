...
namespace DNN4
{
    public class ViewModuleAscx : BaseTemplate
    {
        public ViewModuleAscx()
        {
            base.IsProjectTemplate = false;
            base.CreateOutputFile = true;
            base.Description = "";
            base.Name = "ViewModuleAscx";
            base.OutputFolder = @"DNN4\ViewModuleAscx";
        }
        ...
        public override void ProduceCode()
        {
            ...
            StreamReader reader = new StreamReader(TemplateBase.TemplatesBaseDirectory + "/DNN4/ViewModule.ascx.resx.sct");
