...
namespace DNN4
{
    public class ViewModuleVB : BaseTemplate
    {
        public ViewModuleVB()
        {
            ...
            base.Description = "";
            base.Name = "ViewModuleVB";
            base.OutputFolder = @"DNN4\ViewModuleVB";
        }

        public override string OutputFileName()
        {
            return Table.Code + ".ascx.vb";
        }

        public override void ProduceCode()
        {

            StreamReader reader = new StreamReader(TemplateBase.TemplatesBaseDirectory + "/DNN4/ViewModule.ascx.vb.sct");
