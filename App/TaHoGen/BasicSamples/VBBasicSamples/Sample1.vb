...
Public Class Sample1
    ...
    Public Overloads Overrides Sub ProduceCode()
        ...
        templateReader = New StreamReader(TemplateBase.TemplatesBaseDirectory + "/BasicSamples/VisualBasic/Sample1.sct")
        templateCode = templateReader.ReadToEnd


        'Compile it into a single assembly
        Dim templateAssembly As [Assembly] = TemplateCompiler.Compile(templateCode, "VBSample1.dll", True)
        ...
        properties.Item("CurrentDomain") = MyBase.Domain
        ...
        Dim templateType As Type = templateAssembly.GetType("Samples.Sample1", False, True)
